...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('suggest')
		.setDescription('Suggest stuff to me. I don\'t have infinite ideas for this bot, remember?')
	...
	async run(interaction, client) {
		...
		await interaction.reply({content: 'Suggestion has been sent!', ephemeral: true});
	},
};